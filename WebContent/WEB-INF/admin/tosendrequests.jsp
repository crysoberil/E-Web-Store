<!DOCTYPE html>
<%@page import="com.ewebstore.entity.ProductTransferEntity"%>
...
<title>Products Send Requests</title>
...
<body>
	...
	<div id="wrapper">
				...
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li><a href="#" onclick="reqFunction()"><i
								...
								class="fa arrow"></span></a>
							<ul id="requestslist" class="nav nav-second-level collapse in">
								<li><a class="active"
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Products to Transfer</h1>

					<%
						ArrayList<ProductTransferEntity> transferEntities = (ArrayList<ProductTransferEntity>) request
								.getAttribute("tosendrequests");
						boolean norequest = (Boolean) request.getAttribute("norequest");
						...
						<thead>
							<tr role="row" class="gradeA odd">
								<th tabindex="0" aria-controls="dataTables-example" rowspan="1"
									colspan="1" style="width: 180px;">Transfer ID</th>
								<th tabindex="0" aria-controls="dataTables-example" rowspan="1"
									colspan="1" style="width: 180px;">Product ID</th>
								<th tabindex="0" aria-controls="dataTables-example" rowspan="1"
									colspan="1" style="width: 208px;">Product Name</th>
								<th tabindex="0" aria-controls="dataTables-example" rowspan="1"
									colspan="1" style="width: 208px;">Destination Branch ID</th>
								<th tabindex="0" aria-controls="dataTables-example" rowspan="1"
									colspan="1" style="width: 228px;">Destination Branch Name</th>
								<th tabindex="0" aria-controls="dataTables-example" rowspan="1"
									colspan="1" style="width: 208px;">Quantity</th>
							</tr>
						</thead>

						<tbody>
							<%
								for (ProductTransferEntity transferEntity : transferEntities) {
							%>
							<tr class="gradeA even">
								<td><%=transferEntity.getInventoryTransferID()%></td>
								<td><%=transferEntity.getProductID()%></td>
								<td><%=transferEntity.getProductName()%></td>
								<td><%=transferEntity.getDestinationBranchID()%></td>
								<td><%=transferEntity.getDestinationBranchName()%></td>
								<td><%=transferEntity.getTransferQuantity()%></td>
					...
					<div class="panel panel-default">
						<div class="panel-heading">Dispatch Inventory Product</div>
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-6">
									<form role="form" method="post"
										action="<%=LinkGenerator
						.dispatchInventoryTransferSubmissionLink()%>">

										<div class="form-group">
											<label>Inventory Transfer ID</label> <input
												name="inventorytransferid" class="form-control">
										</div>
