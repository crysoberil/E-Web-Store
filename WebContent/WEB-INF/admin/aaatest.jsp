	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<div class="navbar-header">
				...
				<a class="nav navbar-nav navbar-right" href="index.html" >Jisan Mahmud</a>
			</div>
			<!-- /.navbar-header -->
			...
			<div class="navbar-default sidebar" role="navigation">
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li><a href="orders.html"><i class="fa fa-edit fa-fw"></i>Queued
								Orders</a></li>
						<li><a href="#"><i class="fa fa-sitemap fa-fw"></i> Sales
								Employees<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<li><a href="listSalesPersons.html">All Employees</a></li>
								<li><a href="availableSalespersons.html">Available</a></li>
								<li><a href="onDeliverySalesPersons.html">On Delivery</a></li>
							</ul> <!-- /.nav-second-level --></li>
						<li><a href="productForm.html"><i
								class="fa fa-edit fa-fw"></i> Add Product</a></li>
						<li><a href="salespersonForm.html"><i
								class="fa fa-edit fa-fw"></i> Add Sales Employee</a></li>
						<li><a href="editProductForm.html"><i
								class="fa fa-edit fa-fw"></i> Edit Product</a></li>
			...
			<div class="row">
				<div class="col-lg-8">
					<div class="panel panel-default">
						<div class="panel-heading">
							<i class="fa fa-bar-chart-o fa-fw"></i> Transactions History :
							Area Chart
							<div class="pull-right">
								<div class="btn-group">
									<button type="button"
										...
										Show net income <span class="caret"></span>
									</button>
									<ul class="dropdown-menu pull-right" role="menu">
										<li><a href="#">Show net income</a></li>
										<li><a href="#">Show sales only</a></li>
										<li><a href="#">Show profit only</a></li>
										<li class="divider"></li>
										<li><a href="#">Hide</a></li>
									</ul>
								</div>
