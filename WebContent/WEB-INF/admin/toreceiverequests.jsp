...
<title>Products Receive Requests</title>
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<table
						...
						<thead>
							<tr role="row" class="gradeA odd">
								...
								<th tabindex="0" aria-controls="dataTables-example" rowspan="1"
									colspan="1" style="width: 208px;">Source Branch ID</th>
								<th tabindex="0" aria-controls="dataTables-example" rowspan="1"
									colspan="1" style="width: 228px;">Source Branch Name</th>
								<th tabindex="0" aria-controls="dataTables-example" rowspan="1"
						...
						<tbody>
							...
							<tr class="gradeA even">
								...
								<td><%=transferEntity.getSourceBranchID()%></td>
								<td><%=transferEntity.getSourceBranchName()%></td>
					...
					<div class="panel panel-default">
						<div class="panel-heading">Confirm Inventory Transfer</div>
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-6">
									<form role="form" method="post"
										action="<%=LinkGenerator
						.receiveInventoryTransferSubmissionLink()%>">
