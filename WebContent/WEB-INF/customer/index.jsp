...
<%
	ArrayList<String> categoryNames = (ArrayList<String>) request
			.getAttribute("categoryNames");
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="<%=LinkGenerator.checkoutFormLink()%>"><i
										class="fa fa-crosshairs"></i> Checkout</a></li>
								<li><a href="<%=LinkGenerator.cartPageLink()%>"><i
										class="fa fa-shopping-cart"></i> Cart</a></li>
								<li><a href="<%=LinkGenerator.customerLoginPageLink()%>"><i
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Shop<i
									...
									<ul role="menu" class="sub-menu">
										...
										<li><a href="<%=LinkGenerator.checkoutFormLink()%>">Checkout</a></li>
										<li><a href="<%=LinkGenerator.cartPageLink()%>">Cart</a></li>
										<li><a href="<%=LinkGenerator.customerLoginPageLink()%>">Login</a></li>
									</ul></li>
						...
						<div class="brands_products">
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									...
									%>
									<li><a
										href="<%=LinkGenerator.brandPageLink(brand.getBrandID())%>"><%=brand.getBrandName()%>
									</a></li>
									<%
										}
									%>
